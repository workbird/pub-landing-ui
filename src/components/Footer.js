          ...
          <footer className="m-0 p-0">
               <div className=" py-5 m-0">
                    <div className="row py-4 m-0">
                         ...
                         <div className="col-lg-4 col-md-6 m-0 mb-4 mb-lg-0 px-5 ">
                              <img src={logo} alt="" width="180" className="m-0 logo mb-5" data-aos="flip-left"
                                   data-aos-easing="ease-out-cubic"
                                   data-aos-duration="2000" />

                              <div className=" text-white " style={{ fontSize: "large" }}>
                                   {/* mr-5 */}
                                   <p className='pr-5' data-aos="zoom-in">Workbird Services is a rapidly expanding, cutting-edge technology solutions organization.</p>
                                   <p className='pr-5' data-aos="zoom-in">Automate your business backend with Workbird Services.</p>
                              </div>
                         ...
                         <div className="col-lg-2 col-md-6 mb-4 mb-lg-0 mx-0 px-xl-0 px-sm-5">
                              <h6 className="text-captilized font-weight-bold  color-gold" data-aos="flip-down">Useful Links</h6> <hr className='color-gold h-botoom-hr mt-1  mb-5' data-aos="flip-down" />
                              <ul className="list-bolt mb-0">
                                   <li className="mb-2"><a href="#" className="text-decoration-none text-white text-capitalized" data-aos="zoom-in">Home</a></li>
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-white text-decoration-none text-capitalized" >Services</a></li>
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-white text-decoration-none text-capitalized">FAQs</a></li>
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-white text-decoration-none text-capitalized ">About us</a></li>
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-white text-decoration-none text-capitalized ">Contact us</a></li>
                              </ul>
                         </div>

                         <div className="col-lg-2 col-md-6 mb-4 mb-lg-0 mx-0 px-xl-0 px-sm-5">
                              <h6 className="text-captilized font-weight-bold  color-gold" data-aos="flip-down">Latest News</h6> <hr className='color-gold h-botoom-hr mt-1  mb-5' data-aos="flip-down" />
                              <ul className="list-unstyled mb-0">
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-decoration-none">
                                        <div className='d-flex flex-column'>
                                             ...
                                             <p className='text-white text-justify m-0 p-0'>Mulesoft and Salesforce are among the cutting-edge technologies used by Workbird Services.</p>
                                   ...
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-decoration-none">
                                        <div className='d-flex flex-column'>
                                             ...
                                             <p className='text-white text-justify m-0 p-0'>Workbird goes above and beyond with Mulesoft Integration services.</p>
                                             <hr className='c-dark-gold des-hr mt-1 p-0' />
                                        </div>
                                   </a></li>
                                   <li className="mb-2" data-aos="zoom-in"><a href="#" className="text-decoration-none">
                                        <div className='d-flex flex-column'>
                                             ...
                                             <p className='text-white text-justify m-0 p-0'>Our vision get broadens to support startups and small enterprises.</p>
                         ...
                         <div className="col-lg-4 col-md-6 mb-lg-0 ps-5 d-flex flex-column">
                              <h6 className="text-captilized font-weight-bold  color-gold" data-aos="flip-down">Don't Miss Any Update</h6> <hr className='color-gold h-botoom-hr mt-1  mb-5' data-aos="flip-down" />
               ...
               <div className="bg-dark py-4">
                    <div className="container text-center">
                         <p className="text-white mb-0 py-2 text-capitalize">copyright © 2022 Workbird privacy Policy terms and conditions</p>
                    </div>
               </div>
          </footer >
     )
