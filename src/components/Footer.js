                    ...
                    <div className="col-lg-4 col-md-6 m-0 mb-4 mb-lg-0 px-5 ">
                        ...
                        >
                            ...
                            <p className="pr-5" data-aos="zoom-in">
                                ...
                                cutting-edge technology solutions organization.
                            </p>
                            <p className="pr-5" data-aos="zoom-in">
                                ...
                                <a href="#" className="text-decoration-none">
                                    <div className="d-flex flex-column">
                                        ...
                                        <p className="text-white text-justify m-0 p-0">
                                            Mulesoft and Salesforce are among
                                            the cutting-edge technologies used
                                            by Workbird Services.
                                        </p>
                            ...
                            <li className="mb-2" data-aos="zoom-in">
                                <a href="#" className="text-decoration-none">
                                    <div className="d-flex flex-column">
                                        ...
                                        <p className="text-white text-justify m-0 p-0">
                                            Workbird goes above and beyond with
                            ...
                            <li className="mb-2" data-aos="zoom-in">
                                <a href="#" className="text-decoration-none">
                                    <div className="d-flex flex-column">
                                        ...
                                        <p className="text-white text-justify m-0 p-0">
                                            Our vision get broadens to support
